...
RUN mkdir -p /opt/magnolia/repositories/magnolia/workspaces/category
RUN mkdir -p /opt/magnolia/repositories/magnolia/workspaces/config
RUN mkdir -p /opt/magnolia/repositories/magnolia/workspaces/default
